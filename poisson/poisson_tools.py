...
def get_train_data(pointer=None):
    ...
    '''
    if pointer is None:
        file_name = '/home/adampcloth/PycharmProjects/NE15/poisson/train-images.idx3-ubyte'
    else:
        file_name = pointer + '/train-images.idx3-ubyte'
    f = open(file_name, "rb")
    ...
    if pointer is None:
        file_name = '/home/adampcloth/PycharmProjects/NE15/poisson/train-labels.idx1-ubyte'
    else:
        file_name = pointer + '/train-labels.idx1-ubyte'
    f = open(file_name, "rb")
